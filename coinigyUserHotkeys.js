...
/******************************  
Ctrl+Shift+5 sets to half the available stock , then quads the sell price .. successive hits quad the sell price again and again. 
*/
...
function() {
 ...
 $("#sell_box1").val(sellbox1 = primary_trade_balance/2)
 $("#sell_box2").val(sellbox2 = sellbox2*5) 
 $("#sell_box3").val(sellbox3 = sellbox2 * sellbox1)
...
/****************************** 
Ctrl+Shift+e r[E]set to the primary balance (cant use R because for some reason it refreshes the page on chrome site
*******************************/
...
/****************************** 
Ctrl+Shift+9 resize the buy sell panel
*******************************/
shortcut.add("Ctrl+Shift+9",
function() {
    //if($("#chart_top_container").width()+$("#right_container").width()>$( window ).width() ){
    //    $("#chart_top_container").width($("#chart_top_container").width()-1);
//    }
 console.log("Container Widths:" + Number(Number($("#chart_top_container").width())+Number($("#right_container").width())) + "win: " + Number($( window ).width()  )     )  ;       
},
{ 'type':'keydown', 'propagate':true, 'target':document}
); 
